...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li  class="active"><a href="Student.php"><i class='bx bx-group' ></i>Student</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/Student_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add Students</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/student/student_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update Students</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/Student_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View Students</p>
                        </span>
                    </a>
                </li>
            </ul>
            ...
            <div class="bottom-data">
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                                $recent_student = "SELECT * FROM student ORDER BY enrolment_date DESC LIMIT 5"; // Assuming 'students' is your table name
