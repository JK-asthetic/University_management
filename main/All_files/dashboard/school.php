...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li  class="active"><a href="school.php"><i class='bx bxs-school' ></i>School</a></li>
    ...
    <div class="content">
        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">School</a></li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/school_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add School</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/school/school_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update School</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/school_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View School</p>
                        </span>
                    </a>
                </li>
            </ul>
                ...
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody style="margin-right:50px">
                            <?php
                                $recent_club = "SELECT * FROM school LIMIT 3"; // Assuming 'students' is your table name
