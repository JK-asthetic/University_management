...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/programme_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add Programme</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/programme/programme_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update Programme</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/programme_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View Programme</p>
                        </span>
                    </a>
                </li>
            </ul>
                ...
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody style="margin-right:50px">
                            <?php
                                $recent_programme = "SELECT * FROM programme LIMIT 3"; // Assuming 'students' is your table name
                                $result = mysqli_query($conn, $recent_programme);
