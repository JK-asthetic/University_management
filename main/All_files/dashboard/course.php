...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li   class="active"><a href="course.php"><i class='bx bx-book-open' ></i>Course</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/course_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add Course</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/course/course_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update Course</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/course_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View Course</p>
                        </span>
                    </a>
                </li>
            </ul>
                ...
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody style="margin-right:50px">
                            <?php
                                $recent_club = "SELECT * FROM course LIMIT 3"; // Assuming 'students' is your table name
