...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="committee.php"><i class='bx bx-chat' ></i>committee</a></li>
    ...
    <div class="content">
        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">Committee</a></li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/committee_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add Committee</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/committee/committee_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update Cammittee</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/committee_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View Committee</p>
                        </span>
                    </a>
                </li>
            </ul>
                ...
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody style="margin-right:50px">
                            <?php
                                $recent_club = "SELECT * FROM committee LIMIT 2"; // Assuming 'students' is your table name
                                ...
                                if ($result) {
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<p>' . $row['committee_id'] . '</p>'; 
                                            echo '</td>';
                                            echo '<td>' . $row['committee_title'] . '</td>'; 
                                            echo '<td>' . $row['meeting_frequency'] . '</td>'; 
                                            echo '</tr>'; 
                                        }
                                    }
                                     else {
