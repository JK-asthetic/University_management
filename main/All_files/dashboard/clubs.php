...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="clubs.php"><i class='bx bx-cricket-ball' ></i>Clubs</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/clubs_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add Clubs</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/club/club_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update Clubs</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/clubs_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View Clubs</p>
                        </span>
                    </a>
                </li>
            </ul>
                ...
                <div class="orders">
                    ...
                    <table>
                        ...
                        <tbody style="margin-right:50px">
                            <?php
                                $recent_club = "SELECT * FROM club ORDER BY Day_Created DESC LIMIT 3"; 
