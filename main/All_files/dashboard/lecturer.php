...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li  class="active"><a href="lecturer.php"><i class='bx bxs-user-voice' ></i>Lecturer</a></li>
    ...
    <div class="content">
        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">Lecturer</a></li>
                    </ul>
                </div>
            </div>
            ...
            <ul class="insights">
                <li>
                    <a href="../Add_data/lecturer_add.php">
                        <i class='bx bx-user-plus' style="width:350px" ></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Add Lecturer</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../update_data/lecturer/lecturer_update_1.php">
                        <i class='bx bx-duplicate' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">Update Lecturer</p>
                        </span>
                    </a>
                </li>
                <li>
                    <a href="../View/lecturer_view.php">
                        <i class='bx bx-show-alt' style="width:350px"></i>
                        <span class="info" style="font-size:30px;">
                            <p style="padding:10px 10px">View Lecturer</p>
                        </span>
                    </a>
                </li>
            </ul>
