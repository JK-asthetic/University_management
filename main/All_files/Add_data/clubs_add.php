...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="../dashboard/clubs.php"><i class='bx bx-cricket-ball' ></i>Clubs</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <!-- Form start -->
            <form class="login-form" action="clubs_add.php" method="post">
                <h1><i class='bx bx-user'></i>  Add Clubs</h1>
                ...
                <div class="option-bars">
                    <div class="dropdown">
                        <div class="select">
                            <span class="selected">Campus Id</span>
                            <div class="caret"></div>
                        </div>
                        <ul class="menu">
                             <?php
                                $recent_club = "SELECT * FROM campus"; // Assuming 'students' is your table name
                                ...
                                if ($result) {
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<input type="radio" name="camp_id" value="' . $row['campus_id'] . '" id="' . $row['campus_id'] . '">';
                                            echo '<label for="' . $row['campus_id'] . '">' . $row['campus_id'] .'</label>';
                                            echo '</li>';
                                        }
                                    } else {
                    ...
                    <!-- <div class="dropdown">
                        <div class="select">
                            <span class="selected">Mayank</span>
                            <div class="caret"></div>
                        </div>
                        <ul class="menu">
                            <li class="active">Mayank</li>
                            <li class="option">Github</li>
                            <li class="option">Figma</li>
                            <li class="option">Slack</li>
                            <li class="option">Trello</li>
                        </ul>
                    </div> -->
                </div> 
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="Club_id" id="username1" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username1">Club Id</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="club_name" id="username2" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username2">Club Name</label>
                    </div>
                </div>
                ...
                <div class="address">
                    <div class="form-input-material">
                        <input type="text" name="building_location" id="user2" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">Building Location</label>
                    </div>
                </div>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="number" id="username4" placeholder="" autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Phone Number</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="sport_offer" id="username5" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username5">Sports Offered</label>
                    </div>
                </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id = $_POST["Club_id"];
    $location = $_POST["building_location"];
    $name = $_POST["club_name"];
    $phone_no = $_POST["number"];
    $sport = $_POST["sport_offer"];
    if (isset($id) && isset($location) && isset($name) && isset($phone_no) && isset($sport) && isset($camp_id)){
        if (is_numeric($_POST["number"])){
            $sql = "INSERT INTO club (`club_id`, `club_name`, `building_location`, `phone_number`, `sports_offered`, `campus_id`) VALUES ('$id', '$name', '$location', '$phone_no', '$sport', '$camp_id')";
            ...
            $_SESSION["status"] = "error";
            $_SESSION["text"] = "Please enter a numeric value for Distance";
        }
    } else {
        $_SESSION["status"] = "error";
