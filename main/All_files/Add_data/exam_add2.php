...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <!-- Form start -->
            <form class="login-form" action="exam_add3.php" method="post">
                <h1><i class='bx bx-user'></i> Enter Student Marks Detail</h1>

                <div class="option-bars">

                    <div class="dropdown">
                        <div class="select">
                            <span class="selected">Course Id</span>
                            <div class="caret"></div>
                        </div>
                        <ul class="menu">
                             <?php
                                ...
                                $recent_club = "SELECT programme_id FROM student where student_id = $student_id"; // Assuming 'student' is your table name
                                    ...
                                    if ($sql_result) {
                                        if (mysqli_num_rows($sql_result) > 0) {
                                            while ($row = mysqli_fetch_assoc($sql_result)) {
                                                ...
                                                echo '<input type="radio" name="course_id" value="' . $row['course_id'] . '" id="' . $row['course_id'] . '">';
                ...
                <div class="flex-container" style="width:910px;">
                    <div class="form-input-material">
                        <input type="text" name="grade" id="username4" placeholder="" autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Grade</label>
                    </div>
                </div>
