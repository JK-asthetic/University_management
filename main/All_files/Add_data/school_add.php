...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li  class="active"><a href="../dashboard/school.php"><i class='bx bxs-school' ></i>School</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="school_add.php" method="post">
                <h1><i class='bx bx-user'></i>  Add School</h1>
                ...
                <div class="option-bars">
                    ...
                    <div class="dropdown">
                        <div class="select">
                            <span class="selected">Faculty ID</span>
                            <div class="caret"></div>
                        </div>
                        <ul class="menu">
                            <?php
                                $recent_club = "SELECT * FROM faculty"; // Assuming 'students' is your table name
                                $result = mysqli_query($conn, $recent_club);
                                ...
                                if ($result) {
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            echo '<li class="option">';
                                            echo '<input type="radio" name="faculty_id" value="' . $row['faculty_id'] . '" id="' . $row['faculty_id'] . '">';
                                            echo '<label for="' . $row['faculty_id'] . '">' . $row['faculty_id'] .'</label>';
                                            echo '</li>';
                                        }
                                    } else {
                                        echo '<li>No Campus found.</li>';
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="school_id" id="username1" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username1">School Id</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="school_name" id="username2" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username2">School Name</label>
                    </div>
                </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($id) && isset($location) && isset($name) && isset($camp_id) && isset($faculty_id)){

            $sql = "INSERT INTO school (`school_id`, `school_name`, `building_location`, `campus_id`, `faculty_id`) VALUES ('$id', '$name', '$location', '$camp_id', '$faculty_id')";
