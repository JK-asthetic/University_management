...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="programme_add.php" method="post">
                <h1><i class='bx bx-user'></i>  Add Programme</h1>
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="programme_id" id="username1" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username1">Programme Id</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="programme_code" id="username2" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username2">Programme Code</label>
                    </div>
                </div>
                ...
                <div class="address">
                    <div class="form-input-material">
                        <input type="text" name="programme_title" id="user2" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">Programme Title</label>
                    </div>
                </div>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="level" id="username3" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username3">Level</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="duration" id="username4" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Duration</label>
                    </div>
                </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $code = $_POST["programme_code"];
    $name = $_POST["programme_title"];
    $level = $_POST["level"];
    $duration = $_POST["duration"];

    if (isset($id) && isset($school_id) && isset($name) && isset($code) && isset($level) && isset($duration)){

            $sql = "INSERT INTO programme (`programme_id`, `programme_code`, `programme_title`, `level`, `duration`, `school_id`) VALUES ('$id', '$code', '$name', '$level', '$duration', '$school_id')";
