...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li  class="active"><a href="../dashboard/faculty.php"><i class='bx bxs-user-rectangle' ></i>Faculty</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <!-- Form start -->
            <form class="login-form" action="faculty_add.php" method="post">
                <h1><i class='bx bx-user'></i>  Add Faculty</h1>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="faculty_id" id="username1" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username1">Faculty Id</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="faculty_name" id="username2" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username2">Faculty Name</label>
                    </div>
                </div>
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="dean" id="username4" placeholder="" autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Dean</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="building_location" id="username5" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username5">Building Location</label>
                    </div>
                </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($id) && isset($location) && isset($name) && isset($dean)){
        $sql = "INSERT INTO faculty (`faculty_id`, `faculty_name`, `dean`, `building_location`) VALUES ('$id', '$name', '$dean', '$location')";
