...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="../dashboard/committee.php"><i class='bx bx-chat' ></i>committee</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <!-- Form start -->
            <form class="login-form" action="committee_add.php" method="post">
                <h1><i class='bx bx-user'></i>  Add Committee</h1>
                ...
                <div class="address">
                    <div class="form-input-material">
                        <input type="text" name="committee_title" id="user2" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">Committee Title</label>
                    </div>
                </div>
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="committee_id" id="username1" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username1">Committee Id</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="frequency" id="username2" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username2">Meeting Frequency</label>
                    </div>
                </div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $name = $_POST["committee_title"];

    if (isset($id) && isset($name) && isset($frequency) && isset($faculty_id)){

            $sql = "INSERT INTO committee (`committee_id`, `committee_title`, `faculty_id`, `meeting_frequency`) VALUES ('$id', '$name', '$faculty_id', '$frequency')";
