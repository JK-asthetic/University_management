...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <!-- Form start -->
            <form class="login-form" action="Student_email.php" method="post">
                <h1><i class='bx bx-user'></i>  Add Student</h1>
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="student_name" id="username4" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Student Name</label>
                    </div>
 
                    <div class="form-input-material">
                        <input type="date" name="date" id="username3" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username3">Birth date</label>
                    </div>
                </div>
                ...
                <div class="address">
                    <div class="form-input-material">
                        <input type="email" name="email" id="username2" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username2">Email ID</label>
                    </div>
                </div>
