...
$query = "SELECT `course_code`, `course_title`, `programme_id`, `prerequisite_course_id` FROM `course` WHERE course_id = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $course_id);
$stmt->execute();
$stmt->store_result(); // Store the result for later use
if ($stmt->num_rows > 0) { 
    $stmt->bind_result($code, $course_title, $programme_id, $pre_id);
    $stmt->fetch();
    if ($pre_id == NULL) {
        $pre_id = "NULL";
    }
    ...
    $_SESSION["text"] = "course not found";
...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="course_update_3.php" method="post">
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" id="username5" value =  "<?php echo $course_id; ?>"
                        class="form-control-material"/>
                        <label for="username5">Course ID</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" id="username3" value="<?php echo $pre_id; ?>"
                        class="form-control-material"/>
                        <label for="username3">Prerequisite Course ID </label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material" style="width:460px;">
                        <input type="text" name="title" id="user2" value = "<?php echo $course_title; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
    ...
    <script>
        ...
        document.getElementById("username3").readOnly = true;
    </script>
