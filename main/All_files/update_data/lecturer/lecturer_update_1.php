...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="lecturer_update_2.php" method="post">
                <h1><i class='bx bx-user'></i>Lecturer ID</h1>


                <div class="flex-container" style="width:910px;">
                    <div class="form-input-material">
                        <input type="text" name="lecturer_id" id="username4" placeholder="" autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Lecturer ID</label>
                    </div>
                </div>
