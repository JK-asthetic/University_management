...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="committee_update_2.php" method="post">
                <h1><i class='bx bx-user'></i>Committee ID</h1>


                <div class="flex-container" style="width:910px;">
                    <div class="form-input-material">
                        <input type="text" name="committee_id" id="username4" placeholder="" autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Committee ID</label>
                    </div>
                </div>
