...
$query = "SELECT `faculty_name`, `dean`, `building_location` FROM `faculty` WHERE faculty_id = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $faculty_id);
$stmt->execute();
$stmt->store_result(); // Store the result for later use
if ($stmt->num_rows > 0) { 
    $stmt->bind_result($faculty_name, $dean, $location);
    $stmt->fetch();
} else {
    $_SESSION["status"] = "error";
    $_SESSION["text"] = "faculty not found";
...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="faculty_update_3.php" method="post">
                <h1><i class='bx bx-user'></i>Update Faculty</h1>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" id="username1" value =  "<?php echo $faculty_id; ?>" 
                        class="form-control-material"/>
                        <label for="username1">Faculty ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="faculty_name" id="username6" value = "<?php echo $faculty_name; ?>"
                        class="form-control-material" required />
                        <label for="username6">Faculty Name</label>
                    </div>
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="dean" id="username2" value =  "<?php echo $dean; ?>"
                        class="form-control-material"/>
                        <label for="username2">Dean</label>
                    </div>
