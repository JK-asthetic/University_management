...
$query = "SELECT `student_name`, `birthday`, `programme_id`, `password` FROM `student` WHERE student_id = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $student_id);
$stmt->execute();
$stmt->store_result(); // Store the result for later use
if ($stmt->num_rows > 0) { 
    $stmt->bind_result($name, $BOD, $programme_id, $pass);
    $stmt->fetch();
} else {
    $_SESSION["status"] = "error";
    $_SESSION["text"] = "student not found";
...
<body class="dark">
    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <li class="active"><a href="../../dashboard/Student.php"><i class='bx bx-group'></i>Student</a></li>
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="student_update_3.php" method="post">
                <h1><i class='bx bx-user'></i>Update Student</h1>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" id="username1" value =  "<?php echo $student_id; ?>" 
                        class="form-control-material"/>
                        <label for="username1">Student ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" id="username5" value =  "<?php echo $name; ?>"
                        class="form-control-material"/>
                        <label for="username5">Student Name</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" id="username2" value="<?php echo $BOD; ?>"
                        class="form-control-material" required />
                        <label for="username2">Birthday</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" id="user2" value = "<?php echo $programme_id; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">Programme ID</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material" style="width:455px;">
                        <input type="text" id="username7" name="pass" value="<?php echo $pass; ?>"
                        class="form-control-material" required />
                        <label for="username7">Password</label>
                    </div>
