...
$query = "SELECT `school_name`, `building_location`, `campus_id`, `faculty_id` FROM `school` WHERE school_id = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $school_id);
$stmt->execute();
$stmt->store_result(); // Store the result for later use
if ($stmt->num_rows > 0) { 
    $stmt->bind_result($school_name, $location, $campus_id, $faculty_id);
    $stmt->fetch();
} else {
    $_SESSION["status"] = "error";
    $_SESSION["text"] = "school not found";
...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="school_update_3.php" method="post">
                <h1><i class='bx bx-user'></i>Update Lecturer</h1>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" id="username1" value =  "<?php echo $school_id; ?>" 
                        class="form-control-material"/>
                        <label for="username1">School ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" id="username5" value =  "<?php echo $campus_id; ?>"
                        class="form-control-material"/>
                        <label for="username5">Campus ID</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" id="username2" value =  "<?php echo $faculty_id; ?>"
                        class="form-control-material"/>
                        <label for="username2">Faculty ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="name" id="user2" value = "<?php echo $school_name; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">School Name</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material" style="width:460px;">
                        <input type="text" name="location" id="user1" value = "<?php echo $location; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user1">Location</label>
                    </div>
