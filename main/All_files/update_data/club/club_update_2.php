...
$query = "SELECT `club_name`, `building_location`, `phone_number`, `sports_offered`, `campus_id` FROM `club` WHERE club_id = ?";
$stmt = $conn->prepare($query);
$stmt->bind_param("i", $club_id);
$stmt->execute();
$stmt->store_result(); // Store the result for later use
if ($stmt->num_rows > 0) { 
    $stmt->bind_result($club_name, $location, $phone, $sport, $campus_id);
    $stmt->fetch();
} else {
    $_SESSION["status"] = "error";
    $_SESSION["text"] = "club not found";
...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="club_update_3.php" method="post">
                <h1><i class='bx bx-user'></i>Update Club</h1>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" id="username1" value =  "<?php echo $club_id; ?>" 
                        class="form-control-material"/>
                        <label for="username1">club ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" id="username6" value = "<?php echo $campus_id; ?>"
                        class="form-control-material" required />
                        <label for="username6">Campus ID</label>
                    </div>
                ...
                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" name="club_name" id="username2" value =  "<?php echo $club_name; ?>"
                        class="form-control-material"/>
                        <label for="username2">Club Name</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name="location" id="username7" value = "<?php echo $location; ?>" placeholder=" " autocomplete="off"
                        class="form-control-material" required/>
                        <label for="username7">Building Location</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" name="number" id="user2" value = "<?php echo $phone; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">Phone Number</label>
                    </div>
                    <div class="form-input-material">
                        <input type="text" name="sport" id="user1" value = "<?php echo $sport; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user1">Sports Offered</label>
                    </div>
    ...
    <script>
        ...
        document.getElementById("username6").readOnly = true;
    </script>
