...
$trimmed_id = substr($result_id, -3); // Extract the last three characters of the ID

$query = "SELECT `student_id`, `course_id`, `year`, `term`, `grade` FROM `course_result` WHERE RIGHT(`result_id`, 3) = ?";
...
if ($stmt->num_rows > 0) { 
    $stmt->bind_result($student_id, $course_id, $year, $term, $grade);
    $stmt->fetch();
} else {
    $_SESSION["status"] = "error";
    $_SESSION["text"] = "Result not found";
...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="exam_update_3.php" method="post">
                <h1><i class='bx bx-user'></i>Update Result</h1>

                <div class="flex-container">
                    <div class="form-input-material">
                        <input type="text" id="username1" value =  "<?php echo $result_id; ?>" 
                        class="form-control-material"/>
                        <label for="username1">Result ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" id="username5" value = "<?php echo $student_id; ?>"
                        class="form-control-material"/>
                        <label for="username5">Student ID</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" id="username2" value = "<?php echo $course_id; ?>"
                        class="form-control-material"/>
                        <label for="username2">Course ID</label>
                    </div>

                    <div class="form-input-material">
                        <input type="text" name = "year" id="username6" value = "<?php echo $year; ?>" placeholder=" " autocomplete="off"
                        class="form-control-material" required />
                        <label for="username6">Year</label>
                    </div>
                ...
                <div class="flex-container">
                    ...
                    <div class="form-input-material">
                        <input type="text" name="term" id="username7" value = "<?php echo $term; ?>" placeholder=" " autocomplete="off"
                        class="form-control-material" required/>
                        <label for="username7">Term</label>
                    </div>
                         
                    <div class="form-input-material">
                        <input type="text" name="grade" id="user2" value = "<?php echo $grade; ?>" placeholder=" " autocomplete="off"
                            class="form-control-material" required />
                        <label for="user2">Grade</label>
                    </div>
    ...
    <script>
        ...
        document.getElementById("username2").readOnly = true;
    </script>
