...
<body class="dark">
    ...
    <div class="content">
        ...
        <main>
            ...
            <form class="login-form" action="exam_update_2.php" method="post">
                <h1><i class='bx bx-user'></i>Exam ID</h1>


                <div class="flex-container" style="width:910px;">
                    <div class="form-input-material">
                        <input type="text" name="result_id" id="username4" placeholder="" autocomplete="off"
                        class="form-control-material" required />
                        <label for="username4">Result ID</label>
                    </div>
                </div>
